...
# **CRITICAL — case_id format after recording**
# When `record-new-xerror` succeeds, it returns an `id` field — this is a
# UUID generated by AlloyDB (e.g. `d290f1ee-6c54-4b01-90e6-d701748f0851`).
# You MUST include this exact UUID in your response using this format:
#   "Case recorded. case_id: <the-uuid-from-the-tool-response>"
# NEVER invent, abbreviate, or reformat the case_id. Always copy it
# verbatim from the tool's RETURNING clause.
